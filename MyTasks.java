...
public class MyTasks {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Code Block for FaithfulAspect
    @DoAction
    @Scheduled(cron ="*/5 * * * * *")
    public void eatSomething(){
        System.out.println("I'm Eating Yum.");
    }

    @DoAction
    @Scheduled(cron ="*/5 * * * * *")
    public void Sleepy(){
        System.out.println("One sheep, two sheep, three sheep.");
    }
    ...
    public void Create(){
        ...
        try{
            PrintWriter writer = new PrintWriter("C:/Users/Gabe/Desktop/VehicleAspect.txt", "UTF-8");
            writer.println("Classy creation " + randLetter);
            writer.close();
        }catch(IOException e){
            System.out.println("this creation has failed!");
        }
        System.out.println("Building something classy.");
    }
    @DoAction
    @Scheduled(cron= "*/5 * * * * *")
    public String BigRead(){
        String content = "";
        try {
            content = new Scanner(new File("C:/Users/Gabe/Desktop/VehicleAspect.txt")).useDelimiter("\n").next();
    ...
    @Scheduled(cron ="*/5 * * * * *")
    public void Learn(){
        System.out.println("Learning how to live.");
    }

    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //Vehicle Population Tasks
